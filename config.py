...
STUDENT_ID = "B22DCCN612"          # MSSV VIẾT HOA của bạn
TEACHER_BASE = "http://127.0.0.1:8000/api/v1"   # http://192.168.50.218:8000/api/v1 CHECK LAI IP tren bang hom thi!
MY_SERVER_URL = "http://127.0.0.1:5000"           # IP may MINH + port (xem NOTE.md)
...
LLM_TIMEOUT = 30        # mỗi câu thầy cho 60s, để 40 còn dư retry
